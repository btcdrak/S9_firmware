...
int read_confdata(char *s4_dataformat_dir,char confa[MAXQSIZE_FORMAT][30],char confb[MAXQSIZE_FORMAT][30])
{
    int i,len;
    char* pContent;
...
{
    //DEBUG_printf("before format :%s\n\n",buf_tmp);
    int i;
    char sep[2];
    char confa[MAXQSIZE_FORMAT][30];
    char confb[MAXQSIZE_FORMAT][30];

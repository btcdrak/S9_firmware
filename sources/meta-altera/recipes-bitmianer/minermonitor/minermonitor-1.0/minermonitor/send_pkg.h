...
extern char command_code[COMMAND_SUM][4];
extern char server_command_code[COMMAND_SUM][4];
extern char server_command[COMMAND_SUM][10];
extern char dataformat_conf_dir[COMMAND_SUM][80];
